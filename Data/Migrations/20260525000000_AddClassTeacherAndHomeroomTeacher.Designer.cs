...
namespace StudyAssist.Data.Migrations
{
    ...
    [Migration("20260525000000_AddClassTeacherAndHomeroomTeacher")]
    partial class AddClassTeacherAndHomeroomTeacher
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StudyAssistant.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("ClassLetter").HasColumnType("text");
                    b.Property<string>("ConcurrencyStamp").IsConcurrencyToken().HasColumnType("text");
                    ...
                    b.Property<string>("School").HasColumnType("text");
            ...
            modelBuilder.Entity("StudyAssistant.Models.Class", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("integer");
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("Id"));
                    b.Property<string>("HomeroomTeacherId").HasColumnType("text");
                    b.Property<string>("Name").IsRequired().HasColumnType("text");
                    b.Property<string>("School").IsRequired().HasColumnType("text");
                    b.HasKey("Id");
            ...
            modelBuilder.Entity("StudyAssistant.Models.ChatMessage", b =>
                {
                    ...
                    b.HasOne("StudyAssistant.Models.Subject", "Subject")
                        .WithMany().HasForeignKey("SubjectId").OnDelete(DeleteBehavior.SetNull);
